    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(!this.getConfigView().getTextFieldRow().getText().isEmpty()
            ...
            if(row <= 0 || col <= 0) {
                ...
                if(this.getConfigView().getController().getGameModel().getGame().getDefaultWave().getRow() != row
                        || this.getConfigView().getController().getGameModel().getGame().getDefaultWave().getCol() != col) {
